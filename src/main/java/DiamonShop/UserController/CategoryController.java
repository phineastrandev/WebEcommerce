...
import DiamonShop.Service.PaginatesServiceImpl;
...
public class CategoryController extends BaseController {
	...
	public ModelAndView Product(@PathVariable String id) {			
		...
		_mvShare.addObject("ProductsPaginate", categoryService.GetDataProductsPaninate(Integer.parseInt(id),paginateInfo.getStart(), totalProductsPage));
		return _mvShare;
	}
