...
import DiamonShop.Service.CartServiceImpl;
...
public class CartController extends BaseController {
	...
	public String CheckOutBill(HttpServletRequest request, HttpSession session, @ModelAttribute("bills") Bills bills) {
		...
		bills.setQuanty((Integer) session.getAttribute("TotalQuantyCart"));
		...
		if(billsService.AddBills(bills)>0) {
			...
			_mvShare.addObject("statusBill", "Thanh toan thanh cong!");
		}
