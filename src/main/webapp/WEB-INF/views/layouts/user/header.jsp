...
<header id="header">
	<div class="row">
		<div class="span4">
			<h1>
				<a class="logo" href="index.html"><span>Shopping cart</span> <img
		...
		<div class="span4">
			<div class="offerNoteWrapper">
				<h1 class="dotmark">
					<i class="icon-cut"></i> shopping cart 
				</h1>
			</div>
		</div>
		<div class="span4 alignR">
			<p>
				<br> <strong> Support (24/7) : 0941404225 </strong><br>
				<br>
			</p>
		...
		<div class="container">
			...
			<div class="nav-collapse">
				<ul class="nav">
					...
					<c:forEach items="${menus }" var="item" varStatus="index">
				...
				<ul class="nav pull-right">
					...
					<c:if test="${ not empty LoginInfo }">
						<li><a href="<c:url value="/profile"/>">${ LoginInfo.display_name } <b class="caret"></b></a></li>
					</c:if>
				</ul>
			</div>
		</div>
