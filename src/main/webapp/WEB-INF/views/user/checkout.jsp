				...
				<div class="well">
					<form:form action="checkout" method="POST" modelAttribute="bills"
						...
						<div class="control-group">
							...
							<div class="controls">
								<form:input type="text" path="display_name" placeholder="Name" />
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label">Notes <sup>*</sup></label>
							<div class="controls">
						...
						<div class="control-group">
							<div class="controls">
									<button type="submit"name="submitAccount" class="shopBtn exclusive">Check out</button>
							</div>
						</div>
					</form:form>
				</div>
