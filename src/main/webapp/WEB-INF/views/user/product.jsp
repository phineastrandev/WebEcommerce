				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							...
							VIEW</a> <img
							src="<c:url value="assets/img/user/bootstrap-ecommerce-templates.png"/>"
			...
			<div class="well well-small">
				...
				<div id="myTabContent" class="tab-content tabWrapper">
					...
					<div class="tab-pane fade" id="profile">
						...
						<c:if test="${productByCategoryID.size() > 6}">
							<c:set var="countList" value="6" />
						</c:if>
						<c:forEach var="item" items="${productByCategoryID}" begin="1" end="${countList}">
							<div class="row-fluid">
								<div class="span2">
